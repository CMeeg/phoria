...
public record PhoriaOptions
{
	...
	public PhoriaSsrOptions Ssr { get; set; } = new();
...
public record PhoriaSsrOptions
{
	// TODO: Is this a sensible default?

	public string? Base { get; set; } = "/ssr";

	// TODO: Is this a sensible default?

	/// <summary>
	/// The Vite SSR manifest file path. Default is "client/.vite/ssr-manifest.json".
	/// </summary>
	public string Manifest { get; set; } = Path.Combine("client", ".vite", "ssr-manifest.json");
}
